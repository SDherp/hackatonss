...
type DecarbonizationStrategiesContentProps = {
  source?: string
}

export default function DecarbonizationStrategiesContent({ source }: DecarbonizationStrategiesContentProps) {
  const sourceParam = (source || "electricity").toLowerCase()
        ...
        <main className="px-8 py-8">
          ...
          <section className="mt-8 rounded-2xl border border-gray-200 bg-white p-6">
            ...
            <div className="mt-6 rounded-xl border border-gray-100 bg-white p-5">
              <div className="flex items-center justify-between">
                <div>
                  <h4 className="text-base font-semibold text-gray-900">{activeRate} Reduction Pathway</h4>
